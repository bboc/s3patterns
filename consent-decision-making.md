...
When new wisdom emerges, consent can be withdrawn at any time, usually by bringing a decision again on the agenda of a [Governance Meeting](governance-meeting.html).
...
The principle of consent can be applied with any decision or agreement, including, but not limited to  [Proposal Forming](proposal-forming.html), processing agenda items in the [Governance Meeting](governance-meeting.html), evaluating implemented agreements, the creation of a [Role](role.html), selection of individuals to a role, or effectiveness reviews.
...
The process is designed in a way that both the facilitator and the group will quickly become experts in Consent Decision Making, being able to balance equivalence of individuals and the effectiveness of the group so they can effortlessly navigate a [Governance Meeting](governance-meeting.html) with a large agenda in a short amount of time.
...
After all the objections have been heard, the facilitator helps processing them to integrate the emergent wisdom into the decision. (see [Resolve Objections](resolve-objections.html)
...
A regular [Governance Meeting](governance-meeting.html) helps a group with being more relaxed with decisions, because the participants know they can refine and adapt a decision in the next iteration.

[Evaluate Agreements](evaluate-agreements.html) also helps with faster decisions, because any decision will automatically appear on the agenda of the Governance Meeting. For controversial topics setting a review date in the near future allows participants with concerns about the decision to view it as a short experiment that is contained safely in a time-box.
